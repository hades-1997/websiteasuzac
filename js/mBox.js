...
$(function($) {
	...
	MBox.prototype = {
		...
		build: function() {
			...
			// 	$('<i/>', {
			// 		'class': 'fa fa-fast-backward point mBox-previous float-left hide'
			// 	}).appendTo(navigationArrows);

			// 	$('<i/>', {
			// 		'class': '	fa fa-fast-forward point mBox-next float-right hide'
			// 	}).appendTo(navigationArrows);
		...
		addEventListeners: function() {
			...
			$('icon-zoom.mBox-thumbnail').on('click', $.proxy(function(e) {
